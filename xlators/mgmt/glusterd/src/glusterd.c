...
glusterd_options_init(xlator_t *this)
{
    ...
    /* add by ldg for enable localtime 20241107 begin */
    char *initial_localtime_logging = "enable";
    /* add by ldg for enable localtime 20241107 end */
    ...
    /* add by ldg for enable localtime 20241107 begin */
    ret = dict_set_str(priv->opts, GLUSTERD_LOCALTIME_LOGGING_KEY,
                       initial_localtime_logging);
    if (ret)
        goto out;
    /* add by ldg for enable localtime 20241107 end */
